...
To view a live example, **[click here](https://clochenberg.co.za/)**
...
From your command line, first clone Easyfolio:

```bash
# Clone this repository
$ git clone https://github.com/easyweb-solutions/easyfolio
